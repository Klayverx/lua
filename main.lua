...
while ( continue == 1 ) do
  ...
  if( op == 1 ) then
    ...
    print("A subtração de " ..num1, "e " ..num2, "é: " ..subt)
    ...
    print("A radiciação entre o radicando " ..num1, "e o radical " ..num2, "é: " ..radi)

    print("A potenciação de " ..num1, "elevado a " ..num2, "é: " ..expo)
